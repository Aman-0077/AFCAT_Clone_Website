...
$sql = "select * from candi where s_no='$q'";
                ...
                <div class="content-wrapper full-page-wrapper d-flex  align-items-center auth login-bg">
                    ...
                    <div class="card login mt-4 col-lg-6 col-xl-5 col-xxl-4">
                        <div class="card-body px-5 py-5">
                            ...
                            <form id="registrationForm" method="post" autocomplete="off" action="edit_candi.php?sn=<?php echo $v['s_no']; ?>&pas=<?php echo $v['pass']; ?>">
                                <input type="hidden" name="_csrf" value="25721494-1b02-4b07-b1d5-ef2be50adfda" />
                                ...
                                <div class="form-group">
                                    <label for="cname">Candidate Name <span
                                        ...
                                        onkeypress="clearErrorBoxes()" value="<?php echo $v['cname'];?>">
                                    <div id="candidateNameError" style="color: red;"></div>
                                </div>
                                <div class="form-group">
                                    <label for="fname">Father's Name <span
                                            style="color: red; font-size: 22px;">*</span></label> <input type="text"
                                        id="parentName" required="required" value="<?php echo $v['fname'];?>"
                                ...
                                <div class="form-group">
                                    <label for="mname">Mother's Name <span
                                            style="color: red; font-size: 22px; ">*</span></label> <input type="text"
                                        id="motherName" required="required" value="<?php echo $v['mname'];?>"
                                ...
                                <div class="form-group">
                                    <label for="gender">Gender <span
                                        ...
                                        <option value="Male" <?php if($v['gender']== "Male"){ ?>selected <?php } ?> >Male</option>
                                        <option value="Female" <?php if($v['gender']== "Female"){ ?>selected <?php } ?>>Female</option>
                                        <option value="Trans" <?php if($v['gender']== "Trans"){ ?>selected <?php } ?> >Trans</option>
                                        <option value="Others" <?php if($v['gender']== "Other"){ ?>selected <?php } ?>>Others</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for="dob">Date of Birth<span
                                        ...
                                        id="motherName" required="required" value="<?php echo $v['dob'];?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mx-1" id="mobileNumber" name="mobile"
                                        ...
                                        required="required" onkeypress="clearErrorBoxes()" value="<?php echo $v['mobile'];?>">
                                ...
                                <div class="form-group">
                                    <label for="email">Email ID <span
                                        ...
                                        class="form-control p_input" value="<?php echo $v['email'];?>">
                                ...
                                <div class="form-group">
                                    <label for="pass">Password<span
                                        ...
                                        class="form-control p_input" value="<?php echo $v['pass'];?>">
                                ...
                                <div class="row">
                                    ...
                                    <center>
                                        <div class="col-lg-12 col-md-12 form-group">
                                            <button class="btn btn-primary enter-btn text-center"
                                                style="width: 70%; padding: 10px 20px; font-weight: bold;" type="submit"
                                                id="signupSubmit">Register</button>
                                        </div>
                                    </center>
                                </div>
