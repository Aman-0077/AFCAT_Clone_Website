...
<title>IAF : Admin-Login</title>
<!-- Favicon -->
<link rel="shortcut icon" href="../assets/logo/iaf.png" />
			...
			<div class="bgGray form-container sign-in-container">
				<div class="sign-in-page-data">
					...
					<div class="sign-in-from w-100 m-auto">
						<h1 class="mb-3 text-center">Admin Login</h1><br>
...
<!-------------------- F O R M -------------------------------------------------------------------->
						<form class="mt-4" action="../../login_admin.php" id="userForm"
							...
							<div class="form-group">
								<label for="username">Email ID</label> <input maxlength="50"
							...
							<p class="text-center" style="color: red;">Note : Login Only for Administrator User Not for Candidates !!!</p>
